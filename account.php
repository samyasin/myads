...
if(isset($_POST['submit'])){
    $user = new user();
    if($user->update($user_id,$_POST)){
        $message = "Your Data has been succesfully updated";
    }
}
$userModel = new user();
$user_set = $userModel->fetchById($user_id);
$user_set = $user_set[0];
?>
<!DOCTYPE HTML>
<html>
...
<script>
    ...
    $("document").ready(function() {
        ...
        $('#techno_credits').on("change", function() {
            $(this).next().html($(this).val());
        });
        $('#sport_credits').on("change", function() {
            $(this).next().html($(this).val());
        });
        $('#car_credits').on("change", function() {
            $(this).next().html($(this).val());
        });
        ...
        <form action="account.php" method="post">
            ...
            <div class="col_1_of_2 span_1_of_2">                             
                <div class="col_1_of_2">
                  ...
                  <?php if(isset($user_set['fname'])){
                        echo "value='{$user_set['fname']}'";
                    }else{
                ...
                <div class="col_1_of_2">
                    ...
                    <?php if(isset($user_set['lname'])){
                        echo "value='{$user_set['lname']}'";
                    }else{
                        echo "value='Last Name'";
                    } ?>     
                        >
                </div>
                <div><input type="text" name="birth" id="datepicker" 
                     <?php if(isset($user_set['birth'])){
                        echo "value='{$user_set['birth']}'";
                        }else{
                        echo "value='Date Of Birth'";
                    } ?>></div>
                <div>
                    <select name="gender">
                        <option value="male"
                ...
                <div><input type="text" name="email" 
                     <?php if(isset($user_set['email'])){
                        echo "value='{$user_set['email']}'";
                    }else{
                        echo "value='Email'";
                    } ?>       
                ></div>
                <div>
                    <input type="password" value="<?php echo $user_set['password']; ?>" name="password" ></div>
                <div><input type="password" value=" <?php echo $user_set['password']; ?>"></div>
            </div>
            ...
            <div class="col_1_of_2 span_1_of_2">	                             
                ...
                <div>
                    <select name="occup" id="ocup">
                        <option  <?php if(isset($user_set['occup'])){
                             if($user_set['occup'] == 'student'){
                                 echo "selected='selected'";
                             }                        
                        } ?> value="student">Student</option>
                        <option value="other"  <?php if(isset($user_set['occup'])){
                             if($user_set['occup'] != 'student'){
                                 echo "selected='selected'";
                             }                        
                        } ?> >Other</option>
                    ...
                    <label>Other :</label>
                    <input type="text" name="other_occup" value="<?php if($user_set['occup'] != 'student'){echo $user_set['occup'];} ?>">     
                    </div>
                </div>
                <div>
                    ...
                    <select id="country" name="country" name="country" onchange="change_country(this.value)" class="frm-field required">
                        <?php echo "<option value='{$user_set['country']}'>{$user_set['country']}</option>"; ?>
                ...
                <div>
                    ...
                    <select id="country" name="live" onchange="change_country(this.value)" class="frm-field required">
                        <?php echo "<option value='{$user_set['live']}'>{$user_set['live']}</option>"; ?>
                        <option value="AX">Åland Islands</option>
                        <option value="AF">Afghanistan</option>
                        <option value="AL">Albania</option>
                        <option value="DZ">Algeria</option>
                ...
                <div>
                    ...
                    <select name="religion">
                        <option value="muslim" <?php if(isset($user_set['religion'])){
                             if($user_set['religion'] == 'muslim'){
                                 echo "selected='selected'";
                             }                        
                        } ?> >Muslim</option>
                        <option value="christian" <?php if(isset($user_set['religion'])){
                             if($user_set['religion'] == 'christian'){
                                 echo "selected='selected'";
                             }                        
                        } ?>>Christian</option>
                    </select>                    
                ...
                <div>
                    ...
                    <select name="color">
                        <option value="white" <?php if(isset($user_set['color'])){
                             if($user_set['color'] == 'white'){
                                 echo "selected='selected'";
                             }                        
                        } ?>>White</option>
                        <option value="black" <?php if(isset($user_set['color'])){
                             if($user_set['color'] == 'black'){
                                 echo "selected='selected'";
                             }                        
                        } ?>>Black</option>
                        <option value="red" <?php if(isset($user_set['color'])){
                             if($user_set['color'] == 'red'){
                                 echo "selected='selected'";
                             }                        
                        } ?>>Red</option>
                        <option value="blue" <?php if(isset($user_set['color'])){
                             if($user_set['color'] == 'blue'){
                                 echo "selected='selected'";
                             }                        
                        } ?>>Blue</option>
                        <option value="green" <?php if(isset($user_set['color'])){
                             if($user_set['color'] == 'green'){
                                 echo "selected='selected'";
                             }                        
                        } ?> >Green</option>
                    </select>                    
                ...
                <br>
                <div>    
                    <button class="grey" name="submit" style="font-size: 14px;">Update</button>
